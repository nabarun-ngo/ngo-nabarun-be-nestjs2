...
import { JsonStoreFacade } from 'nestjs-shared/json-store';
import {
 ...
 *
 * Seeding: use `loadJsonStoreSeedFromDir` + `seedJsonStore` from nestjs-shared/json-store
...
export class UserReferenceDataAdapter implements IUserReferenceDataPort {
  ...
  /** Separate namespace for user-module configuration documents. */
